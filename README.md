...
```sh
$ go get -u github.com/coadler/xo

# install with oracle support (see notes below)
$ go get -tags oracle -u github.com/coadler/xo
```
...
$ cp "$GOPATH/src/github.com/coadler/xo/templates/*" templates/
...
$ sudo cp $GOPATH/src/github.com/coadler/xo/contrib/oci8.pc /usr/lib/pkgconfig/
...
$ go install -tags oracle github.com/coadler/xo
```
...
* [dburl](https://github.com/coadler/dburl) - a Go package providing a standard, URL style mechanism for parsing and opening database connection URLs
* [usql](https://github.com/coadler/usql) - a universal command-line interface for SQL databases
